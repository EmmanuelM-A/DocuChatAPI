...
class BaseLogger:
    """The logger responsible for all database logging and log formatting."""

    @staticmethod
    def _get_log_level(level: LogLevel):
        """
        ...
        return level_mappings.get(level.upper(), logging.INFO)

    def get_logger(self, name: str, log_dir: str) -> logging.Logger:
        """
        ...
        log_level = self._get_log_level(settings.logging.LOG_LEVEL)
...
logger = BaseLogger().get_logger(__name__, settings.logging.LOG_DIRECTORY)
